    ...
    return (
        <header className="flex justify-between items-center w-full pl-10 pr-10 pt-2 bg-black z-50 ">
            ...
            <div className="flex gap-2 pr-10">
                <button className="text-xs font-space bg-white/10 p-2 rounded-md border border-white/10"><a href="/"></a>Sin in</button>
                <button className="font-space text-xs bg-white p-2 rounded-md text-black border border-white/10"><a href="/"></a>Registrarse</button>
            </div>
        </header>
    )
}